window.window.Mercury.I18n['ar'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s غير غير مدعوم فى هذا المتصفح. المتصفحات المدعومة هى %s",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor لا يمكن إلا أن يمثل مرة واحدة..",
  ...
  "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "window.window.Mercury.PageEditor غير قاد على تحميل: %s\n\nمن فضلك حدث الصفحة .",
  ...
  "window.Mercury was unable to save to the url: %s": "غير قادر على حفظ الرابط: %s",
  "invalid": "باطل",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "غير قادر على تحميل %s للنافذة \"%s\".",
  "window.Mercury was unable to load %s for the lightview.": "غير قادر على تحميل %s للضوء.",
  "window.Mercury was unable to load %s for the modal.": "غير قادر على تحميل %s للنافذة.",
