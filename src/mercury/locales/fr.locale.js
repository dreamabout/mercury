window.window.Mercury.I18n['fr'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s n'est pas supporté dans ce client. Les navigateurs supportés sont %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor ne peut être démarré qu'une fois.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury n'a pas pu sauvegarder sur l'URL : %s",
  "invalid": "invalide",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury n'a pas pu charger %s pour la fenêtre \"%s\".",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury n'a pas pu charger %s pour l'aperçu.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury n'a pas pu charger %s pour la modale.",
