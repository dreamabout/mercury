...
  "Remove Snippet": "Видалити сніпет",
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s не підтримуються в цьому клієнті. Підтримувані браузери: %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "Тільки один екземпляр window.window.Mercury.PageEditor може бути запущений в один час.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury не вдалося зберегти в url: %s",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury не вдалося завантажити %s для \"%s\" діалогового вікна.",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury не вдалося завантажити %s для lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury не вдалося завантажити %s для модального вікна.",
