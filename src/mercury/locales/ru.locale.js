window.window.Mercury.I18n['ru'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s не поддерживаются в этом клиенте. Поддерживаемые браузеры: %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "Только один экземпляр window.window.Mercury.PageEditor может быть запущен в одно время.",
  ...
  "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "Ошибка загрузки window.window.Mercury.PageEditor: %s\n\nПожалуйста, попробуйте обновить страницу.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury не удалось сохранить в url: %s",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury не удалось загрузить %s для \"%s\" диалогового окна.",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury не удалось загрузить %s для lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury не удалось загрузить %s для модального окна.",
