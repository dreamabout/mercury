window.window.Mercury.I18n['nl'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s niet ondersteund voor deze browser. Ondersteunde browsers zijn: %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor kan maar één keer worden gestart.",
  ...
  "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury was unable to save to the url: %s",
  "invalid": "ongeldig",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury was unable to load %s for the \"%s\" dialog.",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury was unable to load %s for the lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury was unable to load %s for the modal.",
