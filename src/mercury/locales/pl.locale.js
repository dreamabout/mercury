window.window.Mercury.I18n['pl'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.PageEditor is unsupported in this client. Supported browsers are Chrome 10+, Firefox 4+, and Safari 5+.": "window.window.Mercury.PageEditor jest obsługiwany w przeglądarkach: Chrome 10+, Firefox 4+, oraz Safari 5+.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "Instancja window.window.Mercury.PageEditor może być tylko jedna.",
  ...
  "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "window.window.Mercury.PageEditor nie załadował: %s\n\nSpróbuj odświeżyć stronę.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury nie mógł zapisać do podanego url: %s",
  // Confirmations
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury nie mógł załadować %s dla \"%s\".",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury nie mógł załadować %s dla lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury nie mógł załadować %s dla modal.",
