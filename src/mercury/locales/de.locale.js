window.window.Mercury.I18n['de'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s wird von diesem Client nicht unterstützt. Unterstützte Browser sind: %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor kann nur einmal instanziiert werden.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury war nicht in der Lage unter der URL zu speichern: %s",
  "invalid": "ungültig",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury konnte %s nicht für den \"%s\"-Dialog laden.",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury konnte %s nicht für die Lightansicht laden.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury konnte %s nicht für den Modaldialog laden.",
