window.window.Mercury.I18n['zh'] = {
  ...
  _CN_: {
    ...
    // ### General
    // Error Messages
    "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "您的浏览器不支持 window.window.Mercury.Regions.%s，支持的浏览器包括：%s。",
    "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor 只能被实例化一次。",
    "Opera isn't a fully supported browser, your results may not be optimal.": "window.Mercury 编辑器不完全支持 Opera 浏览器，您显示的内容可能并不完美。",
    "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "window.window.Mercury.PageEditor 载入失败：%s\n\n请尝试刷新一下本页。",
    "Region type is malformed, no data-type provided, or \"%s\" is unknown for the \"%s\" region.": "地区不正确，没有提供数据类型，或“%s”不在“%s”区域中。",
    "window.Mercury was unable to save to the url: %s": "window.Mercury 无法保存至这一 URL：%s",
    "invalid": "无效",
    "can't be blank": "不能为空",
    // Confirmations
    ...
    // ### Modals / Dialogs / Etc.
    // Error Messages
    "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury 编辑器无法载入 %s 至“%s”对话框。",
    "window.Mercury was unable to load %s for the lightview.": "window.Mercury 编辑器无法载入 %s 至弹出区域。",
    "window.Mercury was unable to load %s for the modal.": "window.Mercury 编辑器无法载入 %s 至弹出框。",
