window.window.Mercury.I18n['it'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s non è supportato in questo computer. I browser supportati sono %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor può essere istanziato una sola volta.",
  ...
  "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "È fallito il caricamento di window.window.Mercury.PageEditor: %s\n\nProva a ricaricare la pagina.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury non è stato in grado di salvare l'url: %s",
  "invalid": "non valido",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury non è stato in grado di caricare %s per il dialogo \"%s\".",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury non è stato in grado di caricare %s per la lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury non è stato in grado di caricare %s per il dialogo modale.",
