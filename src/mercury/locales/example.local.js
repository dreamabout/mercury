window.window.Mercury.I18n['en'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "",
  "window.window.Mercury.PageEditor can only be instantiated once.": "",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "",
  "window.Mercury was unable to load %s for the lightview.": "",
  "window.Mercury was unable to load %s for the modal.": "",
