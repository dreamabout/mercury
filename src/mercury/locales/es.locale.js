window.window.Mercury.I18n['es'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s no está soportado en este cliente. Los navegadores soportados son %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor solo puede ser llamado una vez.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury no pudo guardar en la url: %s",
  "invalid": "inválido",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury no pudo cargar %s para el diálogo \"%s\".",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury no pudo cargar %s para el lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury no pudo cargar %s para el modal.",
