window.window.Mercury.I18n['sv'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s stöds inte i denna klient. Stödda webbläsare är %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor kan bara ha en instans.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury kunde inte spara till adressen: %s",
  "invalid": "ogiltig",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury kunde inte ladda %s för \"%s\" dialogen.",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury kunde inte ladda %s för lightwiev.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury kunde inte ladda %s för denna modal.",
