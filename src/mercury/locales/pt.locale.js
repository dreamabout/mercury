window.window.Mercury.I18n['pt'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s não aceita seu navegador. Utilize um dos seguintes: %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor não pode ser inicializado duas vezes",
  "Opera isn't a fully supported browser, your results may not be optimal.": "window.window.Mercury.PageEditor não é garantido no navegador Opera, seus resultados podem não ser os esperados.",
  "window.window.Mercury.PageEditor failed to load: %s\n\nPlease try refreshing.": "window.window.Mercury.PageEditor não pôde carregar: %s\n\nPor favor, recarregue a página.",
  ...
  "window.Mercury was unable to save to the url: %s": "",
  "invalid": "inválido",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury não carregou \"%s\" para a janela \"%s\".",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury não carregou \"%s\" na lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury não carregou \"%s\" como modal.",
  ...
  // About window.Mercury Panel (about.html)
