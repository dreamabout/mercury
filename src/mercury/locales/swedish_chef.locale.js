window.window.Mercury.I18n['swedish_chef'] = {
  // ## Javascript Strings
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s is unsooppurted in thees cleeent. Sooppurted broosers ere-a %s Bork Bork Bork!",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor cun oonly be-a instunteeeted oonce-a. Bork Bork Bork!",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury ves uneble-a tu sefe-a tu zee url: %s",
  "invalid": "infeleed",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury ves uneble-a tu lued %s fur zee \"%s\" deeelug.",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury ves uneble-a tu lued %s fur zee leeghtfioo.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury ves uneble-a tu lued %s fur zee mudel.",
