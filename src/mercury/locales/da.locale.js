window.window.Mercury.I18n['da'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s er ikke understøttet i denne browser. Understøttede browsere er %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor kan kun blive instantieret én gang.",
  ...
  "window.Mercury was unable to save to the url: %s": "window.Mercury var ikke i stand til at gemme til addressen: %s",
  "invalid": "ugyldig",
  ...
  // ### Modals / Dialogs / Etc.
  // Error Messages
  "window.Mercury was unable to load %s for the \"%s\" dialog.": "window.Mercury kunne ikke indlæse %s for \"%s\"dialogen.",
  "window.Mercury was unable to load %s for the lightview.": "window.Mercury kunne ikke indlæse %s for lightview.",
  "window.Mercury was unable to load %s for the modal.": "window.Mercury kunne ikke indlæse %s for denna modal.",
