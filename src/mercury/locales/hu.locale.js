window.window.Mercury.I18n['hu'] = {
  ...
  // ### General
  // Error Messages
  "window.window.Mercury.Regions.%s is unsupported in this client. Supported browsers are %s.": "window.window.Mercury.Regions.%s nem támogatott. Támogatott böngészők: %s.",
  "window.window.Mercury.PageEditor can only be instantiated once.": "window.window.Mercury.PageEditor can only be instantiated once.",
  ...
  "window.Mercury was unable to save to the url: %s": "Nem tudtam menteni: %s",
  "invalid": "érvénytelen",
